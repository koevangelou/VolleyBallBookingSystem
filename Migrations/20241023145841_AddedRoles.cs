    ...
    public partial class AddedRoles : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingPlayer", x => new { x.BookingId, x.UserId });
                    table.ForeignKey(
                        name: "FK_BookingPlayer_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BookingPlayer_Bookings_BookingId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "420c6a90-45db-4684-b05d-a4dd38350e7b", "420c6a90-45db-4684-b05d-a4dd38350e7b", "Player", "PLAYER" },
                    { "47b363c6-531d-44f2-bedb-d045ee17ebb6", "47b363c6-531d-44f2-bedb-d045ee17ebb6", "Admin", "ADMIN" },
                    { "f96a96d0-2f38-4614-8cc9-a775a7d78a13", "f96a96d0-2f38-4614-8cc9-a775a7d78a13", "Coach", "COACH" }
                });
